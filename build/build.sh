...
# edited from toast, cav, FLSC-Portfolio, and originally from exMeteo.
...
__NAME__="claw: build.sh"
__AUTHOR__="h4rl"
__DESCRIPTION__="Compiles and links claw into an executable"
...
LINKER_PATHS="-L${LIB}"
LINKER_FLAGS="-lz -lssl -lcrypto -ljansson -lh2o -luv -lm -lbrotlidec -lbrotlienc"
